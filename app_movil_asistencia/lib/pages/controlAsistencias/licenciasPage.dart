...
class LicenciasPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<AsistenciasModel>>(
        future:
            Provider.of<GetControl>(context, listen: false).getLicencias(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No hay licencias existentes.'));
          } else {
